...
const Shopcategory = (props) => {
  ...
  return (
    <div className="Shop_category bg-gray-100 min-h-screen py-16 px-4 sm:px-16">
      <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col sm:flex-row items-center sm:items-start p-8 sm:p-12 mb-12 transition-transform transform hover:scale-105">
        <div className="flex-1 mt-12 flex flex-col justify-center text-center sm:text-left">
          <h1 className="text-7xl font-bold text-gray-800 mb-4 ">
            FLAT 50% OFF
            <span className="block text-7xl mt-4">
              12 <span className=' text-6xl text-[burlywood]'> HOURS </span>  20 <span className='text-6xl text-[burlywood]'> MINUTES </span> 
            </span>
          </h1>
          <Link
        ...
        <div className="flex justify-center mt-8 sm:mt-0">
          <img className="w-64 sm:w-96 transition-transform transform hover:scale-105" src={home} alt="home" />
        </div>
      </div>
      ...
      <div className="shopcategory-indexsort mb-8 text-center">
        <p className="text-gray-600 text-lg">
          Showing <span className="font-bold text-gray-800">1-12</span> out of <span className="font-bold text-gray-800">36</span>
        </p>
      </div>
